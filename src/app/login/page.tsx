    ...
    <main className="min-h-screen bg-stone-100 text-stone-900">
      <div className="mx-auto flex min-h-screen max-w-md items-center px-6">
        <div className="w-full rounded-2xl border border-stone-200 bg-amber-50 p-8 shadow-sm">
          <h1 className="text-2xl font-semibold tracking-tight text-stone-800">Welcome back</h1>
          <p className="mt-2 text-sm text-stone-600">Log in to continue to your dashboard.</p>
          ...
          <p className="mt-4 text-sm text-stone-600">
            Need an account?{" "}
            <Link href="/signup" className="font-medium text-amber-900 hover:underline">
              Sign up
            </Link>
          </p>
        </div>
