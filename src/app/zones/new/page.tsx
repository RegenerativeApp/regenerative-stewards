  ...
  return (
    <main className="min-h-screen bg-stone-100 px-6 py-12">
      <div className="mx-auto max-w-2xl">
        <div className="mb-8">
          <a href="/zones" className="text-sm text-stone-500 hover:text-stone-700">Back to zones</a>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-stone-800">New Zone</h1>
          <p className="mt-1 text-sm text-stone-500 italic">Name a place on your land.</p>
        </div>

        <form action={saveZone} className="rounded-2xl border border-stone-200 bg-amber-50 p-8 shadow-sm space-y-6">
          <div>
          ...
          <div>
            ...
            <textarea name="description" rows={3} placeholder="What is this zone? What's its character, its history, its purpose?" className="w-full rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm text-stone-800 placeholder:text-stone-300 italic focus:outline-none focus:ring-2 focus:ring-stone-400 resize-none" />
          </div>
          ...
          <div className="flex items-center justify-between pt-2">
            <a href="/zones" className="text-sm text-stone-400 hover:text-stone-600">Cancel</a>
            <button type="submit" className="rounded-lg bg-stone-800 px-6 py-2 text-sm font-medium text-stone-100 transition hover:bg-stone-900">Save zone</button>
          </div>
        </form>
      </div>
    </main>
